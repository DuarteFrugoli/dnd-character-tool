...
class LevelUpResult {
  const LevelUpResult({
    required this.targetClassEntryId,
    required this.targetClassName,
    required this.oldTotalLevel,
    required this.newTotalLevel,
    required this.oldClassLevel,
    required this.newClassLevel,
    required this.targetHitDie,
